...
(36, '星際異攻隊２', 'https://goo.gl/zuJUBJ', '博偉', '在「勁爆舞曲大帝國第二集」的歌聲中，本片的故事描述星際異攻隊在努力維繫他們這個新「家庭」之餘，同時也在廣闊的宇宙中四處飛行，希望解開彼得奎爾的身世之謎。隨著漫威電影宇宙持續擴大，舊敵人成了新盟友，甚至是經典漫畫中最受粉絲喜愛的人物也會加入陣容，奧援片中英雄的刺激任務。', 'adventure', '2017-09-08', '輔導級', '137分鐘', '克里斯普瑞特,柔伊莎達娜,戴夫巴帝斯塔,馮迪索', 498),
...
(64, '夜夢效應', 'goo.gl/EKsE34', '獨立', '著迷於基因再生和醒夢現象的利斯博士，在年輕的蓋伯瑞霍瓦斯身上做研究。這個年輕人因為虛擬的夢境與他的真實人生混在一起，生活變得天翻地覆。某天蓋伯瑞的夢境反映了政治暗殺情節，這下他得和時間賽跑，除了保護自己和妻子，還要阻止政府的實驗計畫。時間分秒必爭，蓋伯瑞危在旦夕，真正握有關鍵的人卻是利斯博士。', 'sciencefiction', '2017-12-01', '輔導級', '94分鐘', '凱姆吉甘特,麥可賓恩',299),
(65, '鳳凰城光點事件', 'goo.gl/tSDE9S', '采昌國際多媒體', '1997年3月13日，亞利桑那州鳳凰城發生美國史上最多人目擊的幽浮事件，被稱為「鳳凰城光點」。當晚，有四名鳳凰城居民於附近山區失蹤，至今仍未尋獲。本片以紀錄片形式拍攝，透過機密軍事文件、相關人士採訪與第一手影像資料，還原失蹤事件的真相，發現美國軍方竟牽涉其中…', 'sciencefiction', '2017-11-24', '輔導級', '81分鐘', '奇斯亞雷,尤里洛文塔爾,崔維斯威靈漢,特羅伊貝克,利亞姆奧布萊恩',399),
(66, '陸戰特工', 'goo.gl/qg3eLN', '獨立', '大城市遭到致命病毒侵襲，生還者被隔離在軍事基地。有錢的企業家想從混亂之中救回自己的女兒，只能請來前突襲隊員麥克斯卡特靈幫忙。卡特靈只有一天時間，要闖進一群殭屍中拯救出女孩。然而營救行動過程中，被感染的人類和武裝機器人的攻擊，即將讓卡特靈大開殺戒…', 'sciencefiction', '2017-11-10', '輔導級', '88分鐘', '杜夫朗格林,麥特多蘭,大衛菲爾德,梅蘭尼查奈特',299),
(67, '魔鬼生化人', 'goo.gl/oHDitE', '獨立', '在未來的時空，大型網路病毒滲透X公司，這原是一間高機密、先進的武器工廠。如今，成了末日啟示錄的死亡之地，只有一片廢墟。Ｘ公司的機器人兵團和無人戰鬥機獵殺僅存的人類。為了拯救人類世界，有一群守護者集結，決定要反擊。帶著反情報設備、大型武器重裝上陣，他們就這樣開始了這項任務潛入了X公司總部，從源頭毀壞機械。但當他們來到公司內部，才發現這個網路病毒可不單純…..', 'sciencefiction', '2017-10-27', '限制級', '90分鐘', '丹尼特瑞歐',299),
(68, '巴霍巴利王:磅礡終章', 'goo.gl/W4ny5U', '原創娛樂', '仁德的巴霍巴利王之後──濕婆度，得知自己的身世後，開始尋找一切謎團的解答。巴霍巴利王為何被忠臣卡塔帕所殺？濕婆度有辦法戰勝權謀深算的叔叔帕拉提婆嗎？馬西馬帝王國的最終命運即將揭曉！', 'sciencefiction', '2017-10-27', '輔導級', '167分鐘', '普拉哈斯,拉納達古巴提,安努舒卡謝蒂,特曼娜芭蒂亞',428),
(69, '金剛戰士', 'goo.gl/9vihBQ', '勁藝', '英傑、小晴、比利、珍妮和賽克五名平凡高中生，發現自己所住的城鎮和世界受到外星勢力的侵略，他們受到命運的驅使，被賦予了超異能，開始成為捍衛地球的「金剛戰士」，合力對抗邪惡勢力幽冥女王。', 'sciencefiction', '2017-10-20', '輔導級', '124分鐘', '布萊恩克雷斯頓,伊莉莎白班克斯,娜歐蜜史考特,RJ賽勒,貝琪戈梅,林路迪,達克瑞蒙哥馬利',428),
(70, '異形:聖約', 'goo.gl/bWxTjC', '福斯', '大師級導演雷利史考特繼【絕地救援】後，重返經典回歸其一手打造的科幻史詩鉅作【異形】系列，新作【異形：聖約】將直接與1979年的【異形】故事連結，故事描述殖民太空船聖約號前往浩瀚銀河中一顆遙遠的星球奧瑞加六，航程中成員發現了世人都未知的「天堂」，但當他們抵達時卻發現這個「新世界」埋藏著難以想像的威脅，為了活命他們必須展開驚心動魄的逃亡旅程…', 'sciencefiction', '2017-09-22', '輔導級', '122分鐘', '麥可法斯賓達,凱薩琳華特斯頓,比利克魯德普,德米安畢齊',498),
(71, '巴黎交易員', 'goo.gl/WS8UDB', '海鵬', '他在銀行賺到的錢，遠超過父親幾十個勞碌人生… 傑宏來自布列塔尼，他幸運擠身法興銀行，在獲主管同儕欣賞下，搖身成為巴黎交易員。人生鯉躍龍門，眼界自此大開，而他在股價期貨交易賺到的錢，更遠超過父親幾十個勞碌的人生…。 傑宏的父親是個鍋爐工人，母親則是理髮師。頂著金融碩士頭銜的他，彷彿有彈指魔法，總能幫銀行賺進驚人利潤，卻也逐漸沉迷於一場場的金錢遊戲。傑宏每投必中宛若神助，在銀行默許下，他越發大膽展開最瘋狂交易，不僅買賣金額逐步超越權限，投資金額更超乎銀行股本，導致不可收拾局面，引發那斯達克、道瓊歐盟指數崩盤暴瀉，銀行跟著搖搖欲墜…。 銀行憤怒對傑宏提出控告，使他面臨49億歐元的天價求償！這位「魔鬼交易員」如何能瞞天過海、暗地進行500億歐元的投資？他堅持沒有私吞一毛錢，但憑空消失的鉅款，究竟去了哪裡？一場關乎人性與慾望的金錢遊戲於是登場…', 'sciencefiction', '2017-09-22', '輔導級', '118分鐘', '亞瑟杜朋',399),
(72, '登入火星', 'goo.gl/nHRUFw', '甲上', '一場孤獨卻驚險的太空旅程正要展開 科學家兼太空人威廉隊長被派往火星執行一項單程任務！他將獨自面對四千萬英哩、270天航程的挑戰，正式邁出人類殖民火星第一步 但看似單純簡單的任務，確因為一個錯誤，威廉必須承擔任務取消並折返地球的窘境！但威廉毅然決然決定要繼續前往火星，完成這趟不可能的任務，而他將面對史無前例的挑戰！', 'sciencefiction', '2017-07-28', '輔導級', '90分鐘', '馬克史壯',399),
...
(74, '敦克爾克大行動', 'goo.gl/7Fm2uo', '華納兄弟影業', '【黑暗騎士】、【星際效應】克里斯多夫諾蘭最新作品，這是他首次執導二次世界大戰的題材。【敦克爾克大行動】以二次世界大戰為故事背景，當數十萬名英軍與盟軍被敵人的武力團團包圍，他們的背後只有冰冷的大海，而敵軍正從四方進逼，隨時可以一舉殲滅盟軍。敵軍利用大規模空襲的方式攻擊海灘上無處可躲、彈盡援絕的盟軍。為此，英國下令出動各式大小船隻，冒著猛烈的戰火，出發拯救盟軍。這是改變二次大戰結果的關鍵行動，也是塑造現今世界的決定性事件之一，希望是他們唯一的武器，存活就是勝利。', 'war', '2018-01-05', '輔導級', '106分鐘', '菲昂懷海德,湯姆哈迪',498),
(75, 'USSI:勇者無畏', 'goo.gl/N5SvzQ', '車庫娛樂', '第二次世界大戰期間，戰雲密佈的太平洋戰場，美軍艦長麥維（尼可拉斯凱吉 飾）臨危受命，率巡洋艦「印第安納波利斯」號執行運送原子彈至太平洋戰區的秘密任務。不料途中遭到日軍潛艇攔截擊沉，被迫棄艦求生的數百名官軍於無際汪洋中漂流數日苦等救援，他們不僅得忍受饑餓脫水的痛苦煎熬，還得面對上百尾嗜血鯊魚的威脅。隨著時間一點一滴流逝，這些歷盡磨難且親眼目睹同袍慘遭鯊魚吞噬分食的倖存者們，又該如何撐過這宛如人間煉獄般的絕境？', 'war', '2017-09-08', '輔導級', '130分鐘', '湯姆賽斯摩,尼可拉斯凱吉,湯瑪斯傑恩,寇帝沃克',370),
(76, '決死突擊隊', 'goo.gl/fEP22f', '搖滾萬歲', '二戰1944年盟軍大反攻前的3月，美方策劃了一場諾曼第戰役的前哨入侵突擊行動，名為「大赦計劃」、由一位歷經多次戰役且桀驁不馴的萊斯曼少校，挑選十二名軍事重刑犯，準備潛入法國境內的萊納斯堡，進行暗殺在該處渡假的德軍高階將領，藉以鼓舞盟軍及打擊德軍士氣。少校用減刑的誘因和鋼鐵般的訓練，促使囚犯們逐漸成為足以擔此重任的戰士，但少校特立獨行的行事作風加上囚犯們反社會的性格，期間遭受到高層不少的質疑和阻礙。在歷經一場紅藍軍大對抗且成功擄獲死對頭布立德上校的演習後，這群來自三山五嶽的重刑犯雜牌軍將前往法國執行任務。這支渴望重生的「決死突擊隊」最終能否達成使命.....', 'war', '2017-08-17', '保護級', '150分鐘', '李．馬文,查理士．布朗遜,歐尼斯．鮑寧,唐納．蘇德蘭,泰利．沙瓦拉,約翰．卡薩維蒂,喬治．甘迺迪',99),
(77, '633轟炸大隊', 'goo.gl/3FwbD6', '搖滾萬歲', '二戰期間，挪威反抗軍領袖艾利克冒死劫機逃至英國，帶來德軍在挪威秘密研發飛彈，準備對盟軍展開致命攻擊的情報。英軍命令格蘭特指揮官的蚊式戰鬥轟炸機633中隊，執行摧毀德軍隱身在挪威險峻峽灣飛彈工廠的任務。艾利克奉命返回挪威帶領反抗軍破壞保護工廠的防空陣地，卻不幸被蓋世太保所擄嚴刑拷問；消息傳回英國，為避免任務曝光、急命633中隊在沒有地面支援下全員出動....', 'war', '2017-06-21', '保護級', '90分鐘', '克里夫.羅勃遜,喬治.查格里斯',99),
(78, '代號:鐵鉻行動', 'goo.gl/uuZyMC', '海樂', '1950年6月25日凌晨北韓軍突然南侵攻擊南韓！僅3天首爾就淪陷，40天後除了洛東江外，朝鮮半島全都被北韓軍占領！聯合國軍最高司令官道格拉斯‧麥克阿瑟為了扭轉情勢，瞄準北韓軍的弱點突襲進攻，企劃了「仁川登陸：鐵鉻行動」計畫。為此麥克阿瑟將軍啟動了X光諜戰任務，讓不具編號的特殊情報部隊隊員滲透北韓軍挖出情報。海軍上尉張學修（李政宰 飾）領軍的KLO部隊，成功僞裝成北韓軍，進行滲透，雖暗中執行任務，卻因北韓軍司令官林桂珍（李凡秀飾）而處於有恐洩露身分的危機中。所剩時間是24小時。攸關朝鮮半島歷史與命運的「鐵鉻行動」就此展開！', 'war', '2017-04-28', '輔導級', '111分鐘', '連恩尼遜,李政宰,李凡秀,鄭俊鎬',320),
(79, '鋼鐵英雄', 'goo.gl/mmyvUj', '甲上', '1945年春天，二戰隨著太平洋戰事進入最後階段，但在沖繩島的美軍遭遇前所未見的慘烈苦戰，雙方傷亡人數超過16萬人！一名士兵戴斯蒙杜斯(安德魯加菲 飾)因信仰而拒絕拿任何武器上戰場，數度被同袍恥笑霸凌。但上級下達的撤退命令，部隊所有人都離開時，只有他獨自留下來，憑藉一己之力來回穿梭槍林彈雨中拯救了75名重傷同袍的生命。同年10月杜斯從杜魯門總統手中接過榮譽勳章，成為美國史上最偉大的二戰英雄。', 'war', '2017-04-14', '輔導級', '140分鐘', '泰瑞莎帕瑪,安德魯加菲爾德,山姆沃辛頓,文斯范恩',980),
(80, '將軍之夜', 'goo.gl/qk9gYv', '搖滾萬歲', '1942年二戰德軍佔領區，情報處格勞少校奉命調查一宗發生在華沙、手段極為兇殘的謀殺案，死者是一名具有情報員身分的妓女，在目擊者證詞的拼湊下，兇嫌竟是一名納粹將軍。當時有三位將軍涉案，但三人都不願配合調查，而且都沒有不在場證明。兩年後，巴黎又發生一起手法類似的命案，已是上校的格勞認定坦斯將軍就是兩起謀殺案的變態殺人兇手，在七月二十日刺殺希特勒的行動日，格勞前往逮捕坦斯，但卻被坦斯以其同為謀反黨羽而槍殺。', 'war', '2017-03-24', '保護級', '145分鐘', '彼得．奧圖,奧馬．雪瑞夫,湯姆．寇特尼',99),
(81, '藍徽特攻隊', 'goo.gl/obMahu', '搖滾萬歲', '一戰末期、德軍在西部前線戰事吃緊，嚮往翱翔天空的步兵下士史達赫在飛行學校畢業後晉升中尉，被分發到海德曼上校的飛行中隊。在那飛行仍屬於貴族的年代，空戰被視為是高尚的騎士之戰；史達赫雖出身卑微，但憑著優異的飛行戰技，無視所謂騎士精神、團隊合作而汲汲於打落敵機的紀錄，雖然履立戰功，卻飽受隊上其他飛官鄙視，特別是即將擊落二十架敵機、將獲頒藍徽勳章的威利上尉。而史達赫的表現被柏林方面相中，在宣傳部將軍的包裝下，他成了激勵人民士氣的平民戰爭英雄；而他在此時卻和將軍年輕未婚妻凱蒂結下不倫戀情。在一次威利自己挑起的飛行競技中，威利墜機身亡；而史達赫在後續任務又為求達成獲取勳章紀錄而未遵守命令，中隊長決定把他送至柏林軍事法庭究責.....', 'war', '2016-12-08', '輔導級', '156分鐘', '喬治比柏,詹姆士梅遜,烏蘇拉安德絲',99),
(82, '列車大逃亡', 'goo.gl/dcSwSe', '新動', '美國陸軍航空隊上校 萊恩‧約瑟菲爾 (法蘭克‧辛納屈 飾)出任務時，飛機墜毀在義大利偏遠郊區，被送至距前線200哩，關押著由英國陸軍芬奇少校率領之第九步兵團戰俘的義大利戰俘營。芬奇一直嘗試帶領部隊逃出戰俘營，都以失敗收場！之後他們在被德軍轉移的途中，藉著夜色掩護成功奪取運輸火車，一行人開始在德軍的監控與追擊下，嘗試突破重重難關，準備從義大利一路開向瑞士！', 'war', '2016-11-08', '輔導級', '116分鐘', '法蘭克辛納屈,屈佛霍華',190),
(83, '時空攔截:二戰英豪', 'goo.gl/9nVoeK', '睿客', '757班機的乘客因為神秘原因穿梭時空，回到戰火燎原的 1940年，還成為納粹德軍的俘虜。 絕望的乘客為了重返家園，決心扭轉頹勢，靠自己來贏得贏得歐洲戰場的戰役！', 'war', '2016-10-06', '輔導級', '82分鐘', '法倫塔希爾,羅比凱',399),
(84, '鐵翼雄風', 'goo.gl/eeQ2Ua', '位佳', '在一個小鎮上，兩個年輕人傑克和大衛愛上同一個女孩西爾維亞，因此兩人成了情敵。因為大衛家境富裕，且風度翩翩，他在這場愛情中占據了上風。然而傑克卻因為墜入愛河而盲目以為自己才是她的意中人，他也因此忽略了暗戀著自己的鄰家女孩瑪莉。受愛國情懷與冒險精神的驅使，傑克和大衛報名參軍，成為了一次世界大戰中的飛行員，又恰好被分配到了同一個軍營。一開始他們由於是情敵的關係所以相互作對，不過後來逐漸成為了朋友。他們一同執行飛行任務，並且互相保護，下了飛機到達地面以後依然如此。在一次的空戰中，大衛被敵機擊中墜落，傑克非常的憤怒，誓言要為大衛報仇!', 'war', '2016-10-03', '普遍級', '144分鐘', '克拉拉 鲍,查爾斯 羅傑斯,理查 阿倫',199),

(85, '反恐特警組:十萬火急', 'goo.gl/bkhN62', '索尼影業', '美國緝毒署與霹靂小組聯手追緝案件，霹靂小組探員崔維斯赫爾將一名神秘的囚犯羈壓，但沒想到霹靂小組又被一波又一波的火力給襲擊，崔維斯發現這名囚犯其實大有來頭，他握有價值10億美金軍火情資的晶片，而崔維斯更發現霹靂小組裡面有內賊，讓崔維斯與他的團隊陷入生命的威脅....', 'action', '2017-08-25', '輔導級', '89分鐘', '安卓恩帕利,帕斯卡胡頓,山姆賈格',399),
(86, '午後槍聲', 'goo.gl/KoqTU5', '新動', '老槍手史蒂夫賈德，受銀行委託以一天40美金的報酬，要到庫爾斯金礦將銀行收購的金子安全運回鎮上。史蒂夫深知單槍匹馬很難達成護衛黃金的任務，於是找來了窮困的老搭當赫克與毛躁青年吉爾一起上山。三人途經克努森農場借宿了一晚，認識了虔誠的農場主人與他正值青春年華的女兒愛爾莎。第二天啟程時少女愛爾莎逕自追隨而來，目的是要上庫爾斯山，找礦工比利赫爾曼結婚。赫克和吉爾密謀回程時瓜分掉銀行的金子，不得已時也會要了史蒂夫的性命！但一切計畫，在愛爾莎的婚禮後完全變了調…', 'action', '2017-08-23', '保護級', '93分鐘', '喬爾·麥克雷,蘭道夫·史考特',140),
(87, '攻殼機動隊', 'goo.gl/CovLxv', '派拉蒙', '電影故事講述在不久的未來，少校（史嘉蕾喬韓森 飾）是全新人種的第一人：她本來是一個擁有血肉之軀的人類，但是在發生一場意外被救回一命之後，被裝上強化的生化電子義體，成為一個完美的戰士，致力於打擊世上最危險的罪犯。當恐怖行動發展到了極端，包括能夠駭進人類的大腦和意識，並且控制他們的行為，只有少校擁有的獨特能力能夠阻止新一代的恐怖份子。但是當她面對一個全新的敵人，少校這才赫然發現她所知道的一切都是謊言：她的人生並沒有受到拯救，而是完全被偷走。她將不計代價、竭盡所能，重拾她的記憶、揪出偷走她人生的原兇，並且阻止他們再對其他人做出這種事。', 'action', '2017-07-28', '保護級', '107分鐘', '史嘉蕾喬韓森,麥可彼特',1280),
(88, '金剛:骷髏島', 'goo.gl/vRYRPH', '華納兄弟影業', '在這場令人注目的原創冒險中，一群包括軍人、科學家和探險家的多元團隊，一同探索太平洋上一座看似美麗又危險的的未知島嶼。這群人被隔絕在這個神祕地域，冒險進入強大金剛的地盤，並點燃人類與大自然之間的終極之戰。隨著他們的探險任務變得生死攸關，他們必須努力逃脫這個不屬於人類的原始伊甸園。', 'action', '2017-07-28', '輔導級', '118分鐘', '湯姆希德斯頓,布麗拉爾森',498),
(89, '將軍的子彈', 'goo.gl/44Xuz8', '新動', '職業殺手泰特為了10萬美元報酬，準備暗殺墨西哥叛軍首領埃利亞斯將軍，將軍受到嚴密保護，一般人想見到將軍都屬不易，想要刺殺更是難上加難！於是泰特連續二周都坐在通往墨西哥的火車上，等待著另一支由瓊喬穆諾斯帶領的叛軍來打劫，經過耐心等待計畫終於成功！ 瓊喬搶劫了泰特乘坐的火車，泰特也假扮成懸賞要犯順利的混入叛軍中。瓊喬很欣賞泰特的能力，在泰特的協助下數度打敗墨西哥政府軍，奪得許多財富與槍枝，於是瓊喬帶著泰特與給將軍的軍火，準備到叛軍根據地面見將軍，而泰特隨身的一顆金色子彈，將會是將軍最後的禮物！', 'action', '2017-07-20', '保護級', '137分鐘', '吉安·瑪麗亞·沃爾特,盧·卡斯特爾,馬丁·貝西克,克勞斯·金斯基',140),
(90, '英雄聯盟', 'goo.gl/gKMWrf', '獨立', '外星人侵佔了地球，人類的世界陷入混亂，但這七十億人口中，有個男孩握有摧毀外星人的能力，他們要把這位超級英雄找出來拯救地球。', 'action', '2017-07-14', '保護級', '110分鐘', '羅南昆比,布萊德理查',299),
(91, '羅根', 'goo.gl/WTVMrd', '福斯', '【X戰警】系列最具代表性人物「金鋼狼」推出個人系列電影最終章【羅根】，導演詹姆士曼格注入濃厚西部電影的風格，替金鋼狼休傑克曼與X教授派屈克史都華的謝幕留下感傷的印記。故事發生在不久的將來，離群索居的羅根（休傑克曼 飾）與衰弱的X教授（派屈克史都華）一同流亡在墨西哥邊境。當神秘的少女蘿拉(達芙妮基恩 飾)意外的出現，打破了羅根逃離這個世界的計畫，羅根必須面對黑暗勢力和與自身過去有關的敵人...', 'action', '2017-07-14', '輔導級', '137分鐘', '休傑克曼,派屈克史都華',498),
(92, '刺客教條', 'goo.gl/HHSLfQ', '勁藝', '活在現代的卡倫林區（麥可法斯賓達 飾）透過革命性的科技解開了基因記憶，讓他經歷了15世紀祖先阿基拉在西班牙的冒險，而意外發現自己原來是神祕的「刺客」秘密組織的後代，在獲取驚人知識和技能之後，林區決定起身對抗專制壓迫的現代聖殿騎士們。', 'action', '2017-07-07', '輔導級', '115分鐘', '麥可法斯賓達,傑瑞米艾朗,阿麗安拉蓓,布蘭頓葛利森',428),
(93, '機密同盟', 'goo.gl/Udktbg', '車庫娛樂', '為了顛覆「萬惡美帝」，國際傳言北韓秘密發展幾可亂真的完美偽鈔「超級美鈔」，一旦大量釋出即可輕易摧毀金融市場。但是這項傳聞中的秘密武器，卻被犯罪組織首腦車奇成（金柱赫 飾）竊取，並且捲款潛逃到了南韓。北韓迫不得已向南韓求助，雙方共同進行最高機密的搜索行動，北韓派出特種部隊出身的刑警任鐵零（炫彬 飾） 來到首爾執行任務，協助他尋找超級美鈔下落的則是南韓老鳥警探姜鎮泰（柳海真 飾）。姜鎮泰奉命暗中監視這位北韓貴客一舉一動，亦敵亦友，爾虞我詐的追兇冒險即將引爆！', 'action', '2017-07-07', '保護級', '125分鐘', '炫彬,柳海真,少女時代 潤娥,金柱赫',320),
(94, '命懸生死線', 'goo.gl/qy4mC8', '勁藝', '一場強烈暴風雨來襲，全城陷入大停電，意外事故頻傳，為了替恐慌的市民爭取一線光明，身為電力維修員的波（約翰屈伏塔 飾）和鄧肯，決定放下過去對彼此的成見，冒著風雨和生命危險進行搶修任務。就在此時，鄧肯的女友貝莉（凱特柏絲沃 飾）也因受傷進了醫院，醫院發電機又因暴雨短路，讓這場復電行動陷入更急迫的困境…', 'action', '2017-06-23', '輔導級', '97分鐘', '約翰·屈伏塔,凱特·柏絲沃,戴文·沙瓦,茱莉·賓士,吉爾·貝羅斯,萊恩·羅賓斯和莎朗·史東',428),
(95, '鐵道飛虎', 'goo.gl/WKogJk', '海樂', '講述1941年抗日戰爭期間，足智多謀的鐵道游擊隊隊長-馬原(成龍 飾)，召集鐵道工人與平凡百姓，利用工作經驗成功阻擊日軍突襲，並為百姓奪取生存補給，小蝦米搏倒大鯨魚！ 高手其實在民間！', 'action', '2017-06-09', '保護級', '125分鐘', '成龍',320),
(96, '鋼鐵拳', 'goo.gl/UFVUKh', '獨立', '菜鳥救護員及支援人員上班的第一天晚上，就遇到了受重傷的超級英雄，還因此捲入了他的超級任務中。因事態危機緊急還自願加入組成英雄聯盟，就是要從邪惡組織手中，拯救洛杉磯…', 'action', '2017-05-12', '保護級', '90分鐘', '薇琪喬帝,傑森安敦',299);
