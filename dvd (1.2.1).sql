...
(1, '樓下的房客', 'https:goo.gl/Y5SYUW', '愛貝克思', '『樓下的房客』為2016年暑假上映的黑色、幽默、奇幻、懸疑、推理電影，本片不僅改編自暢銷作家九把刀同名小說，並由崔震東執導並擔任製片、柴智屏監製、 九把刀編劇，黃金鐵三角再次聯手創造話題電影。「每個人的內心就像一個房間，門口緊緊的上了鎖，只有敲開它才能知道，門後也許藏著難以啟齒的私密慾望，也許更藏著一頭無法控制的邪惡巨獸。」導演崔震東表示，「這部電影是藉由一棟既真實又象徵人性的慾望公寓，帶領觀眾走進充滿張力的複雜人性世界，細細品嘗每個房間所隱藏的情慾糾葛。', '恐怖', '2017-10-08', '限制級', '1小時30分', '何潔柔,李杏,莊凱勛,李康生,任達華,邵雨薇,游安順'),
...
(3, '神祕家族', 'https:goo.gl/eV2xSB', '飛擎', '長跑選手苗苗（林依晨 飾）擁有一個平凡幸福的家庭，在平安夜全家慘遭滅門之禍，只有她一人倖存。苗苗看到慘案後失去意識，醒來時，竟發現時間又回到平安夜當天下午，她想要扭轉結局，更要尋找真相，她發現父親（姜武 飾）、母親（惠英紅 飾）和弟弟（陳曉 飾）都在隱藏一個巨大的秘密，這一切要從3年前，苗苗被神秘男子性侵（藍正龍 飾）那夜說起…苗苗狂奔提早回家，見到兇手的真實面貌，果然是雨夜性侵她的男子，她要如何提起勇氣，救回家人呢？', '恐怖', '2017-11-16', '限制級', '92分鐘', '林依晨,姜武,陳曉'),
